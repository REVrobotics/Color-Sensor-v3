...
static constexpr double kColorCompareTolerance = 1e-9;
bool Color::operator==(const Color& color) const {
    return ( ((color.red - red) < kColorCompareTolerance) && 
        ((color.green - green) < kColorCompareTolerance) && 
        ((color.blue - blue) < kColorCompareTolerance) );
}
